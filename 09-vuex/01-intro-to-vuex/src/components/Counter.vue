...
export default {
  ...
  // methods: {
  //   increment() {
  //     // we can use an event bus or pass props around
  //     // this.$emit('updated', 1);
  //     // To change state when using a store we have some options:
  //     // 1) reach directly into the store
  //     // this.$store.state.counter++;
  //     // 2) use mutations (setters)
